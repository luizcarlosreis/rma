...
export default function FooterB() {
  ...
  return (
    <footer className="relative overflow-hidden bg-slate-950 border-t border-slate-900 text-slate-400">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_bottom_left,rgba(34,211,238,0.03),transparent_350px)] pointer-events-none" />
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-12 md:gap-8">
          ...
          <div className="md:col-span-5 flex flex-col space-y-6">
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-slate-900 p-1 shadow-inner border border-slate-800">
                <Image
                  src="/logo.png"
                  alt="RMA Solutions Logo"
                  width={36}
                  height={36}
                  className="brightness-0 invert object-contain filter hue-rotate-[180deg] brightness-125"
                />
              </div>
              <span className="text-lg font-extrabold tracking-tight text-white">
                RMA <span className="text-cyan-400">Solutions</span>
              </span>
            </div>
            ...
            <ul className="space-y-2.5 text-sm">
              {[
                ...
                <li key={item.name}>
                  ...
                  >
                    <ChevronRight className="h-3 w-3 text-cyan-400 transition-transform group-hover:translate-x-1" />
                    <span>{item.name}</span>
                  </Link>
                </li>
              ))}
          ...
          <div className="md:col-span-4 flex flex-col space-y-4">
            ...
            <div className="rounded-xl bg-slate-900/40 border border-slate-800 p-4 text-xs leading-normal">
              <span className="font-semibold text-cyan-400 block mb-1">Garantia de Segurança</span>
        ...
        <div className="flex flex-col items-center justify-between gap-6 text-center text-xs md:flex-row md:text-left">
          ...
          <div className="flex gap-4 text-slate-500 text-[11px]">
            <Link href="/layout-b/politica-de-privacidade" className="hover:text-slate-300 transition-colors">Políticas</Link>
            <span>•</span>
            <Link href="/layout-b/termos-de-uso" className="hover:text-slate-300 transition-colors">Termos</Link>
          </div>
